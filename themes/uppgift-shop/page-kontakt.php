...
<section class="contact-section" style="display: flex; margin: 8%;">
    ...
    if ($stores) : ?>
        <div class="container store-list" style="width: 40%; margin-right: 5%">
            ...
            ?>
                <div class="row store-item mb-4 border-bottom pb-3">
                    <div class="col-md-6">
                        <p class="mb-2"><strong><?php echo esc_html($storeName); ?></strong></p>
                        <?php if ($openHoursWeek): ?>
                            <p>Vardagar: <?php echo esc_html($openHoursWeek); ?></p>
                        <?php endif; ?>
                        <?php if ($openHoursWeekends): ?>
                            <p>Helger: <?php echo esc_html($openHoursWeekends); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
                        <p>Adress: <?php echo esc_html($storeAddress); ?></p>
                        <p>Tel: <?php echo esc_html($storePhone); ?></p>
                        <p>E-post: <?php echo esc_html($storeEmail); ?></p>
                    </div>
                    <img style="width: 70%;" src="<?php echo esc_url($storeImage); ?>" alt="<?php echo esc_attr($storeName); ?>"/>
                </div>
            <?php endforeach; ?>
        </div>
    <?php else : ?>
        <div class="container"><p class="alert alert-warning">No stores found.</p></div>
    <?php endif; ?>
</section>
